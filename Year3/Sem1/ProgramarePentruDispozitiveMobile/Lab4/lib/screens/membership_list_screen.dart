...
class _GymScreenState extends State<GymScreen> {
  ...
  Future<void> _loadMemberships() async {
    // Use await to wait for the result before updating the state
    memberships = await MembershipManager.getAllMemberships();
    // Call setState to trigger a rebuild with the new memberships
    setState(() {});
  }

  Future<void> updateMemberships() async {
    // Call the asynchronous method in updateMemberships
    memberships = await MembershipManager.getAllMemberships();
    // Call setState to trigger a rebuild with the new memberships
    setState(() {});
  }
